...
/**
 * Author:          Kevin </BR>
 * CreatedTime:     2019/3/25 13:44 </BR>
 * Desc:            多状态View管理 </BR>
 * <p>
 * ModifyTime:       </BR>
 * ModifyItems:      </BR>
 ...
 * @author: Kevin
 */
public class LoadAndRetryManager {
    ...
    public LoadAndRetryManager(Object activityOrFragmentOrView, OnLoadingAndRetryListener listener) {
        if (listener == null)
    ...
    public static LoadAndRetryManager generate(Object activityOrFragment, OnLoadingAndRetryListener listener) {
        return new LoadAndRetryManager(activityOrFragment, listener);
    }
